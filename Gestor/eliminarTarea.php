...
<script src="js/confirmacionTareas.js"></script>
    ...
    <div class="row justify-content-center text-center">
        <div class="col-md-10 dark bg-dark text-light" id="principal2">
            ...
            <div class="col-md-9 mx-auto">
                <h1 class="display-5 fw-bold">Eliminar Tarea</h1>
                    ...
                    <form method="post" id="myForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control text-center bg-dark text-light indicador"
                                name="nombretarea" id="nombretarea" placeholder="Nombre" value="<?php print $resultado['nombretarea'] ?>" required readonly>
                        </div>
                        <br>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control text-center bg-dark text-light indicador area" name="descripcion"
                                id="descripcion" placeholder="Descripci&oacute;n ..." required readonly><?php print $resultado['descripcion'] ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select text-center bg-dark text-light indicador" name="idmiembro">
                                <option selected disabled readonly>-- Seleccione un miembro --</option>
                                <?php
                        ...
                        <input type="hidden" class="form-control text-center bg-dark text-light indicador" name="idtarea"
                            id="idtarea" value="<?php print $resultado['idtarea'] ?>" required readonly>
                        <br>
                    </form>
                    <div class="d-grid gap-2 col-4 mx-auto p-1">
                        <button class="btn btn-danger btn-lg" value="<?php print $resultado['idtarea'] ?>" onclick="mostrarDiv('<?php print $resultado['idtarea'] ?>')">Eliminar</button>
