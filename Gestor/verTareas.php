                ...
                <div class="col-md-9 justify-content-center mx-auto">
                    ...
                    <table class="table table-dark" id="myTable">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="btn-group">
                                <a href="editarEquipo.php?idtarea=<?php print $item['idtarea'] ?>" class="btn btn-small btn-warning d-inline"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></a>
                                <a href="eliminarEquipo.php?idtarea=<?php print $item['idtarea'] ?>" class="btn btn-small btn-danger d-inline"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                                </div>
                            </td>
                            <?php
                                }
